...
def benchmark(problems, output_csv, obj):
    ...
    with open(output_csv, "a") as results:
        ...
        for problem_name, topo_fname, tm_fname in problems:
            ...
            try:
                print_(
                    "\nTop formulation, objective {}, {} paths, edge disjoint {}, dist metric {}".format(
                ...
                with open(
                    os.path.join(
                        run_dir,
                        "{}-top-formulation_objective-{}_{}-paths_edge-disjoint-{}_dist-metric-{}.txt".format(
                    ...
                    with open(
                        os.path.join(
                            run_dir,
                            "{}-top-formulation_objective-{}_{}-paths_edge-disjoint-{}_dist-metric-{}_sol-dict.pkl".format(
                                problem_name, obj, num_paths, edge_disjoint, dist_metric
                            ),
                        ),
                        "wb",
                ...
                print_(
                    "Top formulation, objective {}, {} paths, edge disjoint {}, dist metric {}, Problem {}, traffic seed {}, traffic model {} failed".format(
                        obj,
                        num_paths,
                        edge_disjoint,
                        dist_metric,
        ...
        [
            [
                "--top-percentage",
                {
                    "type": float,
                    "default": 0.1,
                    "help": "what percentage of top demands for lp",
                },
            ],
        ],
    )
