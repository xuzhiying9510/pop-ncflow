...
def plot_cdfs(
    ...
    *,
    ...
    if show_legend:
        ...
        figlegend.savefig("legend-client_split_sweep.pdf")
        #legend = ax.legend(
        #    ncol=ncol, loc="upper right", bbox_to_anchor=bbta, frameon=False
        #)
...
def plot_client_split_sweep_cdfs(
    ...
    plot_cdfs(
        ...
        ["+0x clients", "+0.5x clients", "+1x clients"],
        "speedup-cdf-client_split_sweep-poisson",
        x_log=True,
        x_label=r"Speedup ratio",
        xlim=(None,200),
        bbta=(0, 0, 1, 1.4),
        figsize=(6, 4.5),
        ncol=3,
    ...
    plot_cdfs(
        [
            ...
            pop_e50_gravity_df["speedup_ratio"],
            pop_e100_gravity_df["speedup_ratio"],
        ],
        ["+0x clients", "+0.5x clients", "+1x clients"],
        "speedup-cdf-client_split_sweep-gravity",
        x_log=True,
        x_label=r"Speedup ratio",
        xlim=(None,200),
        bbta=(0, 0, 1, 1.4),
    ...
    plot_cdfs(
        ...
        ["+0x clients", "+0.5x clients", "+1x clients"],
        "total-flow-cdf-client_split_sweep-poisson",
        x_log=False,
        x_label=r"Total flow ratio",
        xlim=(0,None),
        bbta=(0, 0, 1, 1.4),
        figsize=(6, 4.5),
        ncol=3,
    ...
    plot_cdfs(
        [
            ...
            pop_e50_gravity_df["flow_ratio"],
            pop_e100_gravity_df["flow_ratio"],
        ],
        ["+0x clients", "+0.5x clients", "+1x clients"],
        "total-flow-cdf-client_split_sweep-gravity",
        x_log=False,
        x_label=r"Total flow ratio",
        xlim=(0,None),
        bbta=(0, 0, 1, 1.4),
